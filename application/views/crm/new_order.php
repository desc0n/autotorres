        ...
        <div class="well col-lg-5">
            <div class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="brand" id="inputBrand" placeholder="Марка" required data-provide="typeahead" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputModel" class="col-lg-3 control-label">Модель</label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="model" id="inputModel" placeholder="Модель" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            <input type="text" class="form-control" name="frame" id="inputFrame" placeholder="Кузов" required>
        ...
        <div class="well col-lg-6">
            ...
            <div class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="last_name" id="inputLastName" placeholder="Фамилия">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputFirstName" class="col-lg-3 control-label">Имя</label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="first_name" id="inputFirstName" placeholder="Имя" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputFatherName" class="col-lg-3 control-label">Отчество</label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="father_name" id="inputFatherName" placeholder="Отчество">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="phone" id="inputPhone" placeholder="Телефон" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPhone2" class="col-lg-3 control-label">Телефон (доп.)</label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="phone2" id="inputPhone2" placeholder="Телефон">
                    </div>
                </div>
                <div class="form-group">
