...
<form method="post" class="form-group">
    <div class="row order-data">
        <div class="well col-lg-5">
            <button class="btn btn-default invoice-btn" onclick="createInvoice(<?=$order['id'];?>);" title="Создать счет">
            ...
            <div class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="model" id="inputModel" placeholder="Модель" required value="<?=$order['model'];?>">
                    </div>
                </div>
                <div class="form-group">
        ...
        <form method="post">
            <table class="table table-bordered order-spares-table">
                ...
                <?foreach ($orderSpares as $spare) {?>
                    <tr>
                        <th colspan="4" class="text-center">Название</th>
                        <th colspan="1" class="text-center">Кол-во</th>
                    </tr>
                    <tr id="spareRow1_<?=$spare['id'];?>">
                        <td colspan="4">
